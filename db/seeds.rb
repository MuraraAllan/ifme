...
user5 = User.create(name: 'Test5 2FA User', email: 'test3@example.com', password: 'passworD@99', location: 'San Francisco, CA, United States', otp_required_for_login: true)
